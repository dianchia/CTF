...
function int_array_to_text(int_array){
  ...
  return txt;
      ...
      //     const chosenPass = document.getElementById('inputPassword').value;
          ...
          const hash = int_array_to_text(string_to_int_array(int_array_to_text(string_to_int_array('spaghetti'))));
          document.write(hash)
...
dxeedxebdwemdwesdxdtdweqdxefdxefdxdu
dxeedxebdwemdwesdxdtdweqdxefdxefdxdudueqduerdvdtdvdu